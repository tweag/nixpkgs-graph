...
def graph(file_read_path, file_save_folder, title, arrows, node_size, edge_width, mode):
    ...
    Args:
        ...
        file_save_folder: The folder path used to store the results, ending with /, default is be './rawdata/'.
    ...
    data.to_csv(file_save_folder + "nodes.csv")

    nx.write_gexf(nxG, file_save_folder + title + ".gexf")
...
def show_graph(nxG, file_save_folder, title, arrows, node_size, edge_width):
    ...
    plt.savefig(file_save_folder + title + ".png")
